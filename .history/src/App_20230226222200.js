      ...
      <Router>
        <div className='App'> 
          ...
          <div className='container'>
            ...
            <Switch> {/*React Router v6 appears to have replaced ("upgraded Switch elements to Routes") the Switch --> Route nesting to BrowserRouter --> Route. see: https://reactrouter.com/en/main/upgrading/v5 */}
              <Route 
                exact 
                path='/' 
                render={props => (
