...
// Get single Github user
  getUser = async (username) => {
    ...
    const res = await axios.get(`https://api.github.com/users/${username}?q=${text}?client_id=$
    {process.env.REACT_APP_GITHUB_CLIENT_ID}&client_secret=$
    {process.env.REACT_APP_GITHUB_CLIENT_SECRET}`);
      ...
      <Router>
        <div className="App">
          ...
          <div className="container">
            ...
            <Routes> {/*React Router v6 appears to have replaced ("upgraded Switch elements to Routes") the Switch --> Route nesting to BrowserRouter --> Route. see: https://reactrouter.com/en/main/upgrading/v5 */}
              <Route
                path="/"
                element={
                  <>
